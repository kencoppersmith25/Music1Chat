            ...
            List {
                ...
                ForEach(player.savedSearchQueues) { saved in
                    categoryRow(
                        ...
                        active: player.activeQueueName?.caseInsensitiveCompare(saved.name) == .orderedSame,
                ...
                ForEach(library.categories) { category in
                    categoryRow(
                        ...
                        active: player.activeQueueName?.caseInsensitiveCompare(category.name) == .orderedSame,
